...
#define APP_ID "4240c2f3c0e5424bb7894342b6ca6e1e"
...
public:
    static CAgoraObject* getInstance(QObject *parent = 0, QString strId = "");
    static CAgoraObject* m_pInstance;
    static std::mutex    m_mutex;

private:
    explicit CAgoraObject(QObject *parent = 0, QString strId = "");
    ~CAgoraObject();
